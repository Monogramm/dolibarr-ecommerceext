            ...
            if ($siteDb->type == 2) { // Woocommerce
                $result = ecommerceext_add_extrafields($db, $langs, [
                    [
                        ...
                        'attrname' => "ecommerceext_wc_regular_price_{$siteDb->id}_{$conf->entity}",
                        ...
                        'attrname' => "ecommerceext_wc_sale_price_{$siteDb->id}_{$conf->entity}",
                        ...
                        'attrname' => "ecommerceext_wc_date_on_sale_from_{$siteDb->id}_{$conf->entity}",
                        ...
                        'attrname' => "ecommerceext_wc_date_on_sale_to_{$siteDb->id}_{$conf->entity}",
                        ...
                        'attrname' => "ecommerceext_wc_role_{$siteDb->id}_{$conf->entity}",
